...
console.log(cidade.toUpperCase(), cidade.length)
...
const precoProduto = "130"

let desconto = precoProduto.includes
...
// 30. Crie um array chamado `frutas3` contendo "pera", "maçã" e "banana". Use `splice` para adicionar "kiwi" entre "maçã" e "b