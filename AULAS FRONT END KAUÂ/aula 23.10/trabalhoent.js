...
let numero2 = 10
let numero3 = 15
let resultado2 = (numero1 + numero2 + numero3) 
...
let chuvendo = false
let frio = false
console.log(`Devo levar guarda chuva? ${chuvendo}
...
let idade1 = 18
console.log(`Eu sou já posso dirigir ${idade1 >= 18}`)
...
let idade2 = 15
console.log(`Maria é maior de idade: ${idade2 >= 18}`)

// 15. Crie duas strings, `senha1` e `senha2`, e verifique se elas são iguais.
let senha1 = "Japamuitolegal"
let senha2 = "Mariamuitochata"
let resultado3 = senha1 === senha2
console.log(resultado3)

// 16. Crie uma string e exiba o número de caracteres que ela contém.
let nome1 = "Kauã Schultz da Silva"
console.log(nome1.length)
// 17. Crie uma variável numérica e verifique se é par ou ímpar usando um operador aritmético.
let numero = 8
console.log(numero % 2 === 0)

// 18. Crie duas variáveis, `nota1` e `nota2`, calcule a média e verifique se a média é maior ou igual a 7.
let nota1 = 3
let nota2 = 4
